        ...
        {!open && (
          ...
          >
            <Button
              ...
              className="w-14 h-14 rounded-full bg-[#10B981] text-white shadow-elevated hover:bg-[#10B981]/90"
            >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-20 right-4 z-50 w-[340px] h-[480px] flex flex-col rounded-2xl overflow-hidden border border-[#D1FAE5] shadow-elevated bg-card"
          >
            <div className="flex items-center justify-between px-4 py-3 bg-[#10B981] text-white">
              ...
              <Button variant="ghost" size="sm" className="p-1 text-white hover:/20" onClick={() => setOpen(false)}>
                <X className="h-4 w-4" />
              </Button>
            </div>
                ...
                >
                  <div className={`flex items-start gap-1.5 max-w-[85%] ${msg.role === "user" ? "flex-row-reverse" : ""}`}>
                    <div className={`w-6 h-6 rounded-full flex items-center justify-center shrink-0 ${
                      msg.role === "user" ? "bg-[#DCFCE7]" : "bg-[#10B981]"
                    }`}>
                      {msg.role === "user" ? (
                        <User className="h-3 w-3 text-[#14532D]" />
                      ) : (
              ...
              <div className="px-3 pb-2 flex flex-wrap gap-1.5">
                {quickPrompts.map((q) => (
                  <button
                    ...
                    className="text-[11px] px-2.5 py-1 rounded-full border border-[#D1FAE5] bg-background hover:bg-muted transition-colors text-[#475569]"
                  >
                    {q}
                  </button>
                ))}
            ...
            <div className="p-3 border-t border-[#D1FAE5] flex items-center gap-2">
              <Input
              ...
              <Button
                ...
                className="h-9 w-9 p-0 bg-[#10B981] text-white"
              >
