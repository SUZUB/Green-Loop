    ...
    <Card className="rounded-[28px] bg-white/10 border border-white/20 backdrop-blur-xl shadow-2xl shadow-emerald-900/20 p-6">
      ...
      {step === 1 && (
        <div className="space-y-4">
          ...
          <Button type="button" className="w-full bg-emerald-600 text-white hover:bg-emerald-700" onClick={() => setStep(2)}>
      ...
      {step === 2 && (
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            ...
            <Button className="flex-1 bg-emerald-600 text-white hover:bg-emerald-700" onClick={() => setStep(3)}>
              Review Request
            </Button>
          </div>
        </div>
      ...
      {step === 3 && (
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            ...
            <Button className="flex-1 bg-emerald-600 text-white hover:bg-emerald-700" onClick={handlePostRequest}>
              Post Request
            </Button>
          </div>
        </div>
