...
const PlasticRoadsAndBricks = () => {
  ...
  return (
    <section className="relative py-24 overflow-hidden">
      <ParallaxBg src={visionRoadsBg} speed={0.4} overlay="bg-foreground/65" />
      ...
      <Dialog open={roadsOpen} onOpenChange={setRoadsOpen}>
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-6 pt-4">
            <div>
              <h4 className="font-semibold text-foreground mb-2">What Are Plastic Roads?</h4>
              <p className="text-sm text-muted-foreground">Plastic roads are built by mixing shredded recycled plastic waste with bitumen and asphalt. The plastic replaces up to 10% of the bitumen traditionally used, creating a stronger, more flexible road surface that lasts 2–3 times longer than conventional roads.</p>
            </div>
            <div>
            ...
            <div className="p-4 rounded-xl bg-muted/50 border border-border">
              <h4 className="font-semibold text-foreground mb-2">🌍 Our Impact So Far</h4>
              <p className="text-sm text-muted-foreground">We've built over <strong>10 km</strong> of plastic roads, reusing <strong>500+ tons</strong> of plastic waste and impacting <strong>25,000+ lives</strong> across multiple communities. Our goal is to reach 100 km by 2027.</p>
            </div>
          </div>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={bricksOpen} onOpenChange={setBricksOpen}>
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-6 pt-4">
            <div>
              <h4 className="font-semibold text-foreground mb-2">What Are Plastic Bricks?</h4>
              <p className="text-sm text-muted-foreground">Plastic bricks are eco-friendly building blocks made by compressing recycled plastic waste with sand and binding agents. They are stronger, lighter, and cheaper than traditional cement bricks — and they help keep plastic out of our environment.</p>
            </div>
            <div>
              <h4 className="font-semibold text-foreground mb-2">Manufacturing Process</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <div>
              <h4 className="font-semibold text-foreground mb-2">Why Plastic Bricks?</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <div className="p-4 rounded-xl bg-muted/50 border border-border">
              <h4 className="font-semibold text-foreground mb-2">🏠 Our Impact So Far</h4>
              <p className="text-sm text-muted-foreground">We've manufactured over <strong>5,000 plastic bricks</strong>, built <strong>12 homes</strong> for underserved communities, and diverted <strong>200+ tons</strong> of plastic from landfills. Each brick contains the equivalent of 200 plastic bags.</p>
            </div>
          </div>
        </DialogContent>
      </Dialog>
  ...
  <section className="relative py-16 overflow-hidden">
    ...
    <div className="container mx-auto px-4 relative z-10">
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-10">
        ...
        <h3 className="text-2xl md:text-3xl font-display font-bold text-primary-foreground mb-2">Future Project</h3>
      ...
      <div className="max-w-3xl mx-auto grid sm:grid-cols-2 gap-4">
        {/* Locations */}
        <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="p-5 rounded-2xl bg-card/90 backdrop-blur-md border border-border/50">
          <h4 className="font-display font-semibold text-foreground text-sm mb-3">📍 Planned Locations</h4>
        ...
        {/* How it works */}
        <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="p-5 rounded-2xl bg-card/90 backdrop-blur-md border border-border/50">
          <h4 className="font-display font-semibold text-foreground text-sm mb-3">⚙️ How It Works</h4>
          <div className="space-y-2">
            {rvmSteps.map((step, i) => (
              <div key={step.title} className="flex items-start gap-2">
                ...
                <p className="text-xs text-muted-foreground"><strong className="text-foreground">{step.title}</strong> — {step.desc}</p>
              </div>
            ))}
          </div>
        </motion.div>
