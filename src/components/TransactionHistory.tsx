...
const statusStyles: Record<string, string> = {
  Complete: "bg-[#10B981]/15 text-[#065F46] border border-emerald-500/20",
  Pending: "bg-[#f6ad55]/15 text-amber-200 border border-[#f6ad55]/20",
};
...
export default function TransactionHistory() {
  ...
  return (
    <Card className="rounded-[32px] bg-white/10 border border-[#D1FAE5] backdrop-blur-xl shadow-2xl shadow-emerald-900/20">
      <div className="flex flex-col gap-4 border-b border-[#D1FAE5] px-6 py-6 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="text-xs uppercase tracking-[0.3em] text-emerald-200/70">Transaction History</p>
          <h2 className="mt-2 text-2xl font-semibold text-[#1E293B]">Live enterprise credit feed</h2>
        </div>
      ...
      <div className="overflow-x-auto px-4 pb-4">
        <Table className="w-full border-separate border-spacing-0 text-sm text-[#1E293B]">
          <TableHeader>
          ...
          <TableBody>
            {transactions.length === 0 ? (
              <TableRow>
                <TableCell className="p-6 text-center text-sm text-[#475569]" colSpan={5}>
