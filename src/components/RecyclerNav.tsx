...
const allNavItems = [
  ...
  { path: "/recycler/history", icon: History, label: "History" },
...
export function RecyclerTopNav({ title }: { title: string }) {
  ...
  return (
    <nav className="sticky top-0 z-50 nav-glass border-b border-[#D1FAE5]">
...
export function RecyclerHorizontalNav() {
  ...
  return (
    <nav className={`sticky top-0 z-50 nav-glass border-b border-[#D1FAE5] transition-shadow duration-200 ${scrolled ? "shadow-md" : ""}`}>
      <div className="container mx-auto flex items-center h-14 px-4 gap-3">
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium whitespace-nowrap transition-colors shrink-0 ${
                    active
                      ...
                      : "text-[#475569] hover:bg-[#F0FDF4] hover:text-[#1E293B]"
                  }`}
                >
...
export function RecyclerBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 nav-glass border-t border-[#D1FAE5] safe-area-bottom">
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-lg transition-colors ${
                active ? "text-[#14532D]" : "text-[#475569] hover:text-[#1E293B]"
              }`}
            >
