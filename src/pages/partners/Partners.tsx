              ...
              <Card className="p-4">
                <div className="flex items-start gap-3">
                  <div className="w-12 h-12 rounded-lg bg-[#F0FDF4] flex items-center justify-center shrink-0">
                    <partner.icon className="h-6 w-6 text-[#14532D]" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      <h3 className="font-semibold text-sm">{partner.name}</h3>
                      <div className="flex items-center gap-0.5 text-xs text-[#065F46]">
                        <Star className="h-3 w-3 fill-[#6fcf97]" /> {partner.rating}
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between mt-3">
                      <div>
                        ...
                        <span className="text-[10px] text-[#475569] ml-2">{partner.points} pts</span>
                      </div>
