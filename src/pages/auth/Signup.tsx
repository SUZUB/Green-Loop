...
const Signup = () => {
  ...
  return (
    <div className="relative min-h-screen bg-transparent flex flex-col isolate overflow-y-auto">
      ...
      <div className="relative z-10 flex-1 flex items-start justify-center px-4 py-8">
        ...
        >
          <div className="text-center mb-8">
            <div className="w-16 h-16 rounded-2xl bg-[#10B981] flex items-center justify-center mx-auto mb-4">
          ...
          <div className="rounded-2xl border border-[#D1FAE5] bg-card shadow-card p-6 md:p-8 space-y-4">
            ...
            <p className="text-center text-sm text-[#475569]">
              ...
              <button onClick={() => navigate(`/auth/login?role=${role}`)} className="text-[#14532D] font-medium hover:underline">Log in</button>
            </p>
          </div>
        </motion.div>
      </div>
