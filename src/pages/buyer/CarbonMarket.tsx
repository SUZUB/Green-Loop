...
const CarbonMarket = () => {
  ...
  return (
    <div className="min-h-screen bg-background/40 pb-28">
      ...
      <nav className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/40 backdrop-blur-xl">
        <div className="container mx-auto flex items-center justify-between gap-4 px-4 py-4">
          <div className="flex items-center gap-3">
            <span className="text-2xl font-display font-semibold tracking-tight text-white">Carbon Market</span>
        ...
        <section className="grid gap-6">
          ...
          >
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              <div>
                <p className="text-sm font-medium uppercase tracking-[0.3em] text-slate-500">Live Available Credits</p>
                <h1 className="mt-3 text-5xl font-display font-bold text-emerald-700">{availableMarketCredits}</h1>
              </div>
              <div className="rounded-3xl bg-slate-900/95 px-5 py-4 text-right text-white shadow-lg shadow-slate-950/20">
                <p className="text-sm uppercase tracking-[0.24em] text-slate-300">Current Rate</p>
          ...
          >
            <div className="mb-6 flex flex-col gap-2">
              <p className="text-sm uppercase tracking-[0.28em] text-slate-500">Select Credits to Purchase</p>
              <h2 className="text-2xl font-semibold text-slate-900">Build your carbon portfolio with confidence.</h2>
              <p className="max-w-2xl text-sm text-slate-600">Choose the number of credits and watch the total update instantly at the live market rate.</p>
            </div>

            <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
              <div className="rounded-3xl bg-slate-950/5 p-5 border border-slate-200/60">
                <div className="flex items-center justify-between gap-3 text-sm text-slate-500">
                  <span>Quantity</span>
                  <span className="text-slate-700">Rate fixed at ₹{CREDIT_PRICE}</span>
                </div>
                <div className="mt-5 flex items-center gap-3">
                  <Button
                    type="button"
                    variant="outline"
                    className="h-12 w-12 rounded-full border-slate-300 text-slate-700 hover:bg-slate-100"
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="h-12 w-12 rounded-full border-slate-300 text-slate-700 hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-50"
                ...
                <div className="mt-6 rounded-3xl bg-emerald-50 p-4 text-slate-700">
                  <p className="text-sm uppercase tracking-[0.24em] text-emerald-700/80">Total Cost</p>
                  <p className="mt-2 text-3xl font-semibold text-emerald-900">₹{totalCost.toLocaleString("en-IN")}</p>
                </div>
              </div>

              <div className="rounded-3xl bg-slate-950/5 p-5 border border-slate-200/60 flex flex-col justify-between">
                <div>
                ...
                <Button
                  type="button"
                  className={`mt-6 w-full ${reachedMax ? "bg-slate-400 text-slate-700" : "bg-emerald-600 text-white hover:bg-emerald-700"}`}
          ...
          {showBilling && (
            ...
            >
              <div className="mb-6 flex flex-col gap-2">
                <p className="text-sm uppercase tracking-[0.28em] text-slate-500">Confirm Billing & Payment Details</p>
                <h2 className="text-2xl font-semibold text-slate-900">Secure the next step in your purchase.</h2>
                <p className="max-w-2xl text-sm text-slate-600">Enter the account details below so the transaction can settle through your corporate payment method.</p>
              </div>
              ...
              <div className="mt-8">
                <Button
                  type="button"
                  className="w-full bg-slate-900 text-white hover:bg-slate-950 disabled:opacity-50"
