      ...
      <div className="container mx-auto px-4 py-6 max-w-lg">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <h2 className="text-lg font-display font-bold mb-3 flex items-center gap-2">
            <Building2 className="h-5 w-5 text-[#065F46]" /> Business Details
          </h2>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  {profile.gstin.length === 15 && (
                    <CheckCircle2 className="absolute right-2 top-2.5 h-4 w-4 text-[#14532D]" />
                  )}
                </div>
              </div>
            </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
          <h2 className="text-lg font-display font-bold mb-3 flex items-center gap-2">
            <User className="h-5 w-5 text-[#065F46]" /> Contact Person
          </h2>
          <Card className="p-5 space-y-4 mb-6">
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
          <h2 className="text-lg font-display font-bold mb-3 flex items-center gap-2">
            <Factory className="h-5 w-5 text-[#065F46]" /> Buying Preferences
          </h2>
          <Card className="p-5 space-y-4 mb-6">
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                {plasticTypes.map((pt) => (
                  <label key={pt.id} className="flex items-center gap-2 p-2 rounded-lg border border-[#D1FAE5] hover:bg-white/50 cursor-pointer transition-colors">
                    <Checkbox
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
          <h2 className="text-lg font-display font-bold mb-3 flex items-center gap-2">
            <FileText className="h-5 w-5 text-[#065F46]" /> Verification Documents
          </h2>
          <Card className="p-5 mb-6">
            <p className="text-sm text-[#475569] mb-3">Upload your business registration and compliance documents.</p>
        ...
        <Button
          onClick={handleSave}
          disabled={saving}
          className="w-full gap-2 bg-[#10B981] text-white hover:bg-[#10B981]/90"
          size="lg"
        >
