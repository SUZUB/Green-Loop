      ...
      <div className="container mx-auto px-4 py-6 max-w-lg">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <Card className="bg-hero-gradient p-6 rounded-2xl mb-6 text-center">
            ...
            <h2 className="text-white font-display font-bold text-lg mb-1">Invite Friends, Earn Points</h2>
            <p className="text-white/70 text-sm mb-4">Earn 50 bonus points for each friend who completes their first pickup!</p>
            <div className="/20 rounded-xl p-3 flex items-center justify-between mb-4">
              <span className="font-display font-bold text-white text-lg tracking-wider">{referralCode}</span>
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          <Card className="p-4 text-center">
            <Users className="h-5 w-5 mx-auto mb-1 text-[#14532D]" />
            <div className="text-xl font-display font-bold">{referrals.length}</div>
            <p className="text-[10px] text-[#475569]">Invited</p>
          </Card>
          <Card className="p-4 text-center">
            ...
            <p className="text-[10px] text-[#475569]">Completed</p>
          </Card>
          <Card className="p-4 text-center">
            <Gift className="h-5 w-5 mx-auto mb-1 text-[#065F46]" />
            <div className="text-xl font-display font-bold">{totalEarned}</div>
            <p className="text-[10px] text-[#475569]">Pts Earned</p>
          </Card>
        </div>
            ...
            <motion.div key={i} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.05 }}>
              <Card className="p-4 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-[#475569]">{ref.date}</p>
                </div>
                <div className="text-right">
                  ...
                  {ref.bonus > 0 && <p className="text-xs text-[#14532D] font-bold mt-1">+{ref.bonus} pts</p>}
                </div>
              </Card>
            </motion.div>
          ))}
